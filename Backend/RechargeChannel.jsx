      ...
      <div className="overflow-auto max-h-[80vh]">
        <table className="w-full table-fixed text-sm text-gray-800">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              <th className="w-[200px] px-4 py-3 text-center font-semibold uppercase text-gray-600">通道名</th>
              <th className="w-[120px] px-4 py-3 text-center font-semibold uppercase text-gray-600">费率</th>
          ...
          <tbody className="divide-y divide-gray-100">
            {channels.map((ch) => (
              <tr key={ch.id} className="hover:bg-gray-50 text-center align-middle">
                ...
                <td className="px-4 py-3">{ch.rate}%</td>
